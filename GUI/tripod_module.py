...
class Window(wx.Frame):
	...
	def InitUI(self):
		...
		st2 = wx.StaticText(panel, label='Zoom')
		st2.SetFont(font)
		hbox4.Add(st2, flag=wx.RIGHT, border=8)
		bttn1 = wx.Button(panel, label='+', size=(70, 30))
		hbox4.Add(bttn1, flag=wx.ALIGN_TOP, border=5)
		bttn2 = wx.Button(panel, label='-', size=(70,30))
