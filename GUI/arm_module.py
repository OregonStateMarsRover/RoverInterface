...
class ArmSim(wx.Panel):
	...
	def __init__(self,parent):
		wx.Panel.__init__(self, parent=parent, id=wx.ID_ANY,size=(300,300))
...
class ArmControls(wx.Panel):
	def __init__(self,parent,arm_sim):
		wx.Panel.__init__(self, parent=parent, id=wx.ID_ANY,size=(500,150))
		...
		btnIn = wx.Button(self,label=u"\u2190",size=(30,20))
		btnUp = wx.Button(self,label=u"\u2191",size=(30,20))
		btnOut = wx.Button(self,label=u"\u2192",size=(30,20))
		btnDown = wx.Button(self,label=u"\u2193",size=(30,20))
		
		btnWristR = wx.Button(self,label=u"\u21BB")
		btnWristL = wx.Button(self,label=u"\u21BA")
		
		btnScoopO = wx.Button(self,label='Open')
		btnScoopC = wx.Button(self,label='Close')
		...
		gridSizer.Add(self.srv1,(1,1))
		gridSizer.Add(self.srv2,(2,1))
		gridSizer.Add(self.srv3,(3,1))
	
		gridSizer.Add(btnIn,(2,2),flag=wx.EXPAND)
		gridSizer.Add(btnUp,(1,3),flag=wx.EXPAND)
		gridSizer.Add(btnOut,(2,4),flag=wx.EXPAND)
		gridSizer.Add(btnDown,(3,3),flag=wx.EXPAND)
		
		gridSizer.Add(armTxt,(0,2),flag=wx.EXPAND|wx.ALIGN_CENTER_VERTICAL|wx.TOP,border=14)
		gridSizer.Add(wristTxt,(0,6),flag=wx.EXPAND|wx.ALIGN_CENTER_VERTICAL|wx.TOP,border=14)
		gridSizer.Add(scoopTxt,(2,6),flag=wx.EXPAND|wx.ALIGN_CENTER_VERTICAL|wx.TOP,border=14)
		
		gridSizer.Add(srv1Txt,(1,0),flag=wx.EXPAND|wx.ALIGN_CENTER_VERTICAL)
		gridSizer.Add(srv2Txt,(2,0),flag=wx.EXPAND|wx.ALIGN_CENTER_VERTICAL)
		gridSizer.Add(srv3Txt,(3,0),flag=wx.EXPAND|wx.ALIGN_CENTER_VERTICAL)
		
		gridSizer.Add(btnWristR,(1,7),flag=wx.EXPAND)
		gridSizer.Add(btnWristL,(1,6),flag=wx.EXPAND)
		gridSizer.Add(btnScoopO,(3,6),flag=wx.EXPAND)
		gridSizer.Add(btnScoopC,(3,7),flag=wx.EXPAND)
