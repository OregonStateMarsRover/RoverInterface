...
class Arm():
	...
	def findPos(self):
		...
		self.roverStatus.arm_seg[0]['pos'] = (self.roverStatus.arm_seg[0]['len']*math.cos(self.roverStatus.arm_seg[0]['angle']),self.roverStatus.arm_seg[0]['len']*math.sin(self.roverStatus.arm_seg[0]['angle']))
		self.roverStatus.arm_seg[1]['pos'] = (self.roverStatus.arm_seg[1]['len']*math.cos(angle2)+self.roverStatus.arm_seg[0]['pos'][0],self.roverStatus.arm_seg[1]['len']*math.sin(angle2)+self.roverStatus.arm_seg[0]['pos'][1])
		self.roverStatus.arm_seg[2]['pos'] = (self.roverStatus.arm_seg[2]['len']*math.cos(angle3)+self.roverStatus.arm_seg[1]['pos'][0],self.roverStatus.arm_seg[2]['len']*math.sin(angle3)+self.roverStatus.arm_seg[1]['pos'][1])
	...
	def drawArm(self):
		...
		self.findPos()
		data = [(0,0),self.roverStatus.arm_seg[0]['pos'],self.roverStatus.arm_seg[1]['pos'],self.roverStatus.arm_seg[2]['pos']]
		lines = PolyLine(data)
...
class ArmControls(wx.Panel):
	def __init__(self,parent,arm_sim,roverStatus):
		...
		self.srv1 = wx.SpinCtrl(self,value='%d'%int(round(math.degrees(self.roverStatus.arm_seg[0]['angle']))),size=(60, -1))
		self.srv1.SetRange(0,90)

		self.srv2 = wx.SpinCtrl(self,value='%d'%int(round(math.degrees(self.roverStatus.arm_seg[1]['angle']))),size=(60, -1))
		self.srv2.SetRange(0,360)
		

		self.srv3 = wx.SpinCtrl(self,value='%d'%int(round(math.degrees(self.roverStatus.arm_seg[2]['angle']))),size=(60, -1))
	...
	def OnButton(self,e,value):
		print(value)
		self.arm_sim.arm.target = [self.roverStatus.arm_seg[1]['pos'][0],self.roverStatus.arm_seg[1]['pos'][1]]
