...
class GUI():
	...
	self.root = tk.Tk()
        ...
        self.label_LJLeftRight = tk.Label(self.root, text="LJ/LeftRight").grid(row=28, padx=5, sticky="E")
        self.label_LJUpDown = tk.Label(self.root, text="LJ/UpDown").grid(row=29, padx=5, sticky="E")
        self.label_RJLeftRight = tk.Label(self.root, text="RJ/LeftRight").grid(row=30, padx=5, sticky="E")
        self.label_RJUpDown = tk.Label(self.root, text="RJ/UpDown").grid(row=31, padx=5, sticky="E")
        self.label_Packet = tk.Label(self.root, text="Packets coming from controller (Bytes 0-7)").grid(row=32, \
									column=2, columnspan=8, pady=10, sticky="W")
        self.label_Packet0 = tk.Label(self.root, text="Byte 0").grid(row=33, column=1, padx=5, sticky="E")
        self.label_Packet1 = tk.Label(self.root, text="Byte 1").grid(row=33, column=2, padx=5, sticky="E")
        self.label_Packet2 = tk.Label(self.root, text="Byte 2").grid(row=33, column=3, padx=5, sticky="E")
        self.label_Packet3 = tk.Label(self.root, text="Byte 3").grid(row=33, column=4, padx=5, sticky="E")
        self.label_Packet4 = tk.Label(self.root, text="Byte 4").grid(row=33, column=5, padx=5, sticky="E")
        self.label_Packet5 = tk.Label(self.root, text="Byte 5").grid(row=33, column=6, padx=5, sticky="E")
        self.label_Packet6 = tk.Label(self.root, text="Byte 6").grid(row=33, column=7, padx=5, sticky="E")
        self.label_Packet7 = tk.Label(self.root, text="Byte 7").grid(row=33, column=8, padx=5, sticky="E")
        self.label_HEX = tk.Label(self.root, text="HEX --->").grid(row=34, column=0, padx=5, sticky="E")
        self.label_DECIMAL = tk.Label(self.root, text="DECIMAL --->").grid(row=35, column=0, padx=5, sticky="E")
        ...
        self.variable_LJLeftRight = tk.Label(text="")
        self.variable_LJUpDown = tk.Label(text="")
        self.variable_RJLeftRight = tk.Label(text="")
        self.variable_RJUpDown = tk.Label(text="")
        ...
        self.variable_LJLeftRight.grid(row=28, column=1)
        self.variable_LJUpDown.grid(row=29, column=1)
        self.variable_RJLeftRight.grid(row=30, column=1)
        self.variable_RJUpDown.grid(row=31, column=1)
        self.variable_Packet0.grid(row=34, column=1, sticky="E")
        self.variable_Packet1.grid(row=34, column=2, sticky="E")
        self.variable_Packet2.grid(row=34, column=3, sticky="E")
        self.variable_Packet3.grid(row=34, column=4, sticky="E")
        self.variable_Packet4.grid(row=34, column=5, sticky="E")
        self.variable_Packet5.grid(row=34, column=6, sticky="E")
        self.variable_Packet6.grid(row=34, column=7, sticky="E")
        self.variable_Packet7.grid(row=34, column=8, sticky="E")
        self.variable_Packet0_INT.grid(row=35, column=1, sticky="E")
        self.variable_Packet1_INT.grid(row=35, column=2, sticky="E")
        self.variable_Packet2_INT.grid(row=35, column=3, sticky="E")
        self.variable_Packet3_INT.grid(row=35, column=4, sticky="E")
        self.variable_Packet4_INT.grid(row=35, column=5, sticky="E")
        self.variable_Packet5_INT.grid(row=35, column=6, sticky="E")
        self.variable_Packet6_INT.grid(row=35, column=7, sticky="E")
        self.variable_Packet7_INT.grid(row=35, column=8, sticky="E")
        # Start tracking time
    ...
    def update_labels(self):
        ...
        self.variable_LJLeftRight.configure(text=str(self.states['LJ/LeftRight']))
        self.variable_LJUpDown.configure(text=str(self.states['LJ/UpDown']))
        self.variable_RJLeftRight.configure(text=str(self.states['RJ/LeftRight']))
        self.variable_RJUpDown.configure(text=str(self.states['RJ/UpDown']))
